...
func (b *NATSBackend) SaveCheckpoint(ctx context.Context, jobID string, state json.RawMessage) error {
	b.cpStore.mu.Lock()
...
func (b *NATSBackend) GetCheckpoint(ctx context.Context, jobID string) (*core.Checkpoint, error) {
	b.cpStore.mu.RLock()
...
func (b *NATSBackend) DeleteCheckpoint(ctx context.Context, jobID string) error {
	b.cpStore.mu.Lock()
	defer b.cpStore.mu.Unlock()
